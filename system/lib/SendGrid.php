...
class SendGrid
{
    ...
    public function __construct($apiUserOrKey = null, $apiKeyOrOptions = null, $options = array())
    {
        if(isset($apiUserOrKey,$apiKeyOrOptions))
        {
            $this->init($apiUserOrKey,$apiKeyOrOptions,$options);
        }
    }
    
    public function init($apiUserOrKey, $apiKeyOrOptions = null, $options = array())
    {

...
import HighLigth from './components/HighLigth.vue.js?v=1.1.7'
import PlaceHolder from './components/PlaceHolder.vue.js?v=1.1.7'
import Badge from './components/Badge.vue.js?v=1.1.7'

$(document).ready(function () {
  ...
  String.prototype.getFullLanding = function () {
    return `https://www.universodejade.com/${this}`;
  };
  ...
  String.prototype.isValidCurp = function () {
    ...
    if (result[2] != validateDigit(result[1])) return false;
  ...
  const alertImage = async (
    { image: image, _class: _class, icon: icon, size: size },
    delay = 500
  ) => {
    await _closeModal();

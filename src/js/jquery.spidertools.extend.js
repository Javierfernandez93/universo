...
(function($)
{
	...
	$.__createLi = function(liOptions){
		...
		if(liOptions.dataRole!=null && liOptions.dataRole!="") li.attr("data-role",liOptions.dataRole);
	...
	$.__createSpan = function(spanOptions){
		...
		if(spanOptions.id!=null && spanOptions.id!="") span.attr("id",spanOptions.id);
	...
	$.__createImage = function(imageOptions){
		// Creamos un div
		...
		if(imageOptions.className!=null && imageOptions.className!="")	imageObj.attr("className",imageOptions.className);

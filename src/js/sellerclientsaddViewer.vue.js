...
import { BackViewer } from '../../src/js/backViewer.vue.js?v=1.1.5' 
import ModalViewer from '../../src/js/modalViewer.vue.js?v=1.1.5'
import ClientModel from '../../src/js/models/client.module.js?v=1.1.5'

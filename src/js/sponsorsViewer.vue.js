...
import PlaceHolder from '../../src/js/components/PlaceHolder.vue.js?v=1.0.2' 
import HighLigth from '../../src/js/components/HighLigth.vue.js?v=1.0.2' 
...
const SponsorsViewer = {
    ...
    methods: {
        ...
        goToEdit(company_id) {
            window.location.href = '../../apps/admin-sponsor/edit?usid='+company_id
        },
        addPermission() {
                    ...
                    <div class="card-header pb-0">
                        <div class="row gx-2 align-items-center">
                            ...
                            <div class="col-auto text-end">
                                <a href="../../apps/admin-sponsor/add" type="button" class="btn shadow-none mb-0 btn-success px-3 btn-sm">Añadir líder</a>
                            </div>
                            <div class="col-auto text-end">
                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Afiliación</th>
                                ...
                                <tbody>
                                    <tr v-for="administrator in administrators" class="text-sm text-center">
                                        <td class="text-start">

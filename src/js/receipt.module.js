...
class Receipt extends Http {
    ...
    getCommissionReceipt(data, callback) {
        return this.call('../../app/application/getCommissionReceipt.php', data, callback);
    }
    signCommissionFile(data, callback) {
        return this.call('../../app/application/signCommissionFile.php', data, callback);
    }
}

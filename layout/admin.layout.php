...
<head>
    ...
    <link id="pagestyle" href="../../src/css/soft-ui-dashboard-admin.css?v=1.1.7" rel="stylesheet" />
    
    <link rel="stylesheet" href="../../src/css/admin-general.css?v=1.1.7" />

    <link id="pagestyle" href="../../src/css/admin.min.css?v=1.1.7" rel="stylesheet" />

    {{css_scripts}}
</head>

<body class="g-sidenav-show bg-gradient-special">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 border-radius-xl shadow-none" id="navbarBlur" navbar-scroll="true">
            ...
            <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
                <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                    <form method="get" action="../../apps/admin-client/" class="input-group">
                        <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
                        <input type="text" id="query" name="query" class="form-control" placeholder="Type here...">
                    </div>
                </div>
                <ul class="navbar-nav  justify-content-end">
                    <li class="nav-item d-flex align-items-center">
                        ...
                        <span class="d-sm-inline d-none"><?php echo $UserSupport->getName() ?></span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item px-3 d-flex align-items-center">
                        <a href="../../apps/admin-config" class="nav-link p-0 text-body">
    ...
    <script src="../../src/js/general.js?v=1.1.7" type="text/javascript"></script>
    <script src="../../src/js/toastCtrl.js?v=1.1.7" type="text/javascript"></script>
    <script src="../../src/js/alertCtrl.js?v=1.1.7" type="text/javascript"></script>
    
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-select@1.14.0-beta2/dist/css/bootstrap-select.min.css">

    <!-- Github buttons -->
    <script async defer src="../../src/js/buttons.min.js"></script>
    <script src="../../src/js/soft-ui-dashboard.min.js?v=1.1.7.6"></script>

...
<body data-bs-theme="dark">
    <nav class="navbar navbar-expand-lg shadow-none py-4 px-5 sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img  src="../../src/img/otoch/logo.png" alt="logo" style="width: 12rem;"/>
            </a>
            ...
            <div class="collapse oleo navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#imagine">Imagina Otoch</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#meaning">¿Qué significa Otoch?</a>
                    </li>
                ...
                <div class="d-flex align-items-center">
                    <a target="_blank" href="https://maps.app.goo.gl/LCeuszfwUexXgSt1A?g_st=iw" class="me-3 text-uppercase text-md text-dark">
            ...
            <div class="row align-items-center justify-content-lg-between">
                <div class="col-lg-6 mb-lg-0 mb-4">
                    <div class="copyright text-center text-sm text-dark text-lg-start">
                        ...
                        <a href="https://www.universodejade.com/" class="font-weight-bold text-dark" target="_blank">Site - admin site</a>
                        for a better web.
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <script src="../../src/js/alertCtrl.min.js?v=1.1.7" type="text/javascript"></script>

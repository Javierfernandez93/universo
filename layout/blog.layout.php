    ...
    <nav class="fixed-top py-2 py-xl-3">
        <header class="container d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-xl-3 mb-0">
            ...
            <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="../../apps/home/us" class="nav-link px-2 <?php if($route == JFStudio\Router::BLOG) {?>text-success<?php } ?>">COMUNIDAD DE JADE</a></li>
                <li><a href="../../apps/home/about" class="nav-link px-2 <?php if($route == JFStudio\Router::About) {?>text-success<?php } ?>">NOSOTROS</a></li>
            </ul>

...
<body class="g-sidenav-show bg-light">
    ...
    <script src="../../src/js/soft-ui-dashboard.js?v=1.1.4"></script>
    
    <script src="../../src/js/cookie.min.js?v=1.1.4" type="text/javascript"></script>
    <script src="../../src/js/vue.js?v=1.1.4" type="text/javascript"></script>
    <script src="../../src/js/language.vue.js?v=1.1.4" type="module"></script>

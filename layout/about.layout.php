...
<body class="">
    ...
    <script src="../../src/js/constants.js?v=2.4.6.4" type="text/javascript"></script>
    <script src="../../src/js/alertCtrl.js?v=2.4.6.4" type="text/javascript"></script>
    <script src="../../src/js/jquery-3.5.1.min.js" type="text/javascript"></script>
    <script src="../../src/js/general.js?v=2.4.6.4" type="text/javascript"></script>

    <!-- Github buttons -->

    <script async defer src="../../src/js/buttons.js"></script>
    <!-- Control Center for Soft Dashboard: parallax effects, scripts for the example pages etc -->
    <script src="../../src/js/soft-ui-dashboard.min.js?v=2.4.6.4"></script>

...
<body class="">
    <nav class="sticky py-3 py-xl-5">
        <header class="container d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-xl-3 mb-0">
            ...
            <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="../../apps/home/us" class="nav-link text-white px-2 <?php if($route == JFStudio\Router::Us) {?>text-success<?php } ?>">COMUNIDAD DE JADE</a></li>
    ...
    <script src="../../src/js/constants.js?v=1.1.7" type="text/javascript"></script>
    ...
    <script src="../../src/js/soft-ui-dashboard.min.js?v=1.1.7"></script>

    ...
    <nav class="navbar navbar-expand-lg shadow-none py-4 sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img  src="../../src/img/kelaya/logo.png" alt="logo" style="width:6rem;"/>
            </a>
            ...
            <div class="collapse oleo navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#imagine">Imagina Kelaya</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#meaning">¿Qué significa Kelaya?</a>
                    </li>
                ...
                <div class="d-flex align-items-center">
                    <a target="_blank" href="https://maps.app.goo.gl/bs2mRrjAr2SEehiR9?g_st=iw" class="me-3 text-uppercase text-md text-light">

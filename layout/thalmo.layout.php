        ...
        <div class="container-fluid">
            ...
            <div class="collapse oleo navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#imagine">Imagina Thalmo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#meaning">¿Qué significa Thalmo?</a>
                    </li>
                </ul>
                <div class="d-flex align-items-center">
                    <a target="_blank" href="https://maps.app.goo.gl/zixLVCuA4u9B1uot8?g_st=com.google.maps.preview.copy" class="me-3 text-uppercase text-md text-dark">

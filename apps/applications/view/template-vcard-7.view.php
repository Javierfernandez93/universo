<div class="row justify-content-center">
    <div class="col-11 col-md-6 col-xl-4">
        <div class="card rounded-0 border-0 blur">
            ...
            <div class="row justify-content-center px-4 align-items-center  mt-n3">
                <div class="col-auto mt-n7">
                    <div class="avatar avatar-xxl">
                        <img src="{{image}}" style="object-fit:cover" class="img-fluid avatar avatar-xxl rounded-circle shadow-lg">
                    </div>
                </div>
                <div class="col">
                    <div class="card bg-transparent border-0 m-0 shadow-none">
                        <div class="card-body">
                            <div class="text-dark fs-2">{{name}}</div>
            ...
            <div class="card-body">
                ...
                <div class="card mb-3 border-0 bg-transparent shadow-none">
                    <div class="card-body">

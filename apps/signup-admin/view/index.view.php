				...
				<div class="row box-vertical-center">
					<div class="col-12 px-3 py-3">
						...
						<div data-form='name' class="form-group">
							<label for="name"><t>Nombre completo</t>*</label>
		     				<input type="text" class="form-control" id="name" data-field="true" data-message="Ingresa tu nombre completo" data-type="text">
						</div>
						<div data-form='name' class="form-group">
							<label for="name"><t>Cedula Profesional</t>*</label>
		     				<input type="text" class="form-control" id="cedula" data-field="true" data-message="Ingresa tu cedula profesional" data-type="text">
						</div>

<div id="app">
    ...
    <section class="border-bottom border-secondary text-center d-flex justify-content-center align-items-center h-500">
        <div class="container expand animation-fall-down" style="--delay:150ms">
            <div class="text-center oleo">
                <span class="px-3">Descubre</span>
                <span class="px-3">
                    <i class="bi bi-star-fill text-primary"></i>
                </span>
                <span class="px-3 ">Pandorah</span>
            </div>
            <div class="display-1 oleo">
                Descubre 
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-6 lead text-dark">
                    <div>Crea un futuro seguro para tu familia...</div>
                    <div>Pandorah es la opción que puede hacer realidad es nuevo capítulo en tu vida y la de tus seres queridos</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="row g-5 py-3 text-uppercase letter-spacing-3 expand animation-fall-down oleo" style="--delay:350ms" id="imagine">
        ...
        <div class="col-xl text-center font-color">
            Y Pandorah es el lugar donde vivimos
        </div>
        <div class="col-xl-auto mx-5 d-md-block d-none">
            <i class="bi bi-star-fill text-primary"></i>
        </div>
            ...
            <div class="col-12 col-md-6 col-xl-4 text-center">
                <div class="card bg-dark-special card-body p-5">
                    <div class="card-body px-0">
                        ...
                        <div class="h3 oleo text-dark mb-3">Imagina <span class="text-primary">Pandorah</span></div>
                        <div class="text-dark lead">
                            En una zona con un alto crecimiento inmobiliario, generando plusvalía cada año. Con cercanía a la ciudad de Mérida y a los puertos más importantes del estado
                        </div>
                    </div>
                    
                    <div class="card-footer d-flex justify-content-center px-0">
                        <a target="_blank" :href="'9995013045'.sendWhatsApp('¡Hola! Quiero conocer Pandorah ¿Puedes darme más información?')" class="btn btn-primary btn-lg shadow-none">
        ...
        <div class="container position-absolute z-index-1 expand animation-fall-down" style="--delay:750ms">
            <div class="row w-100 justify-content-end align-items-center mb-n3">
                <div class="col-12 col-xl-6">
                    <div class="display-2 oleo">
                        <span class="text-primary">Invierte</span>
                    </div>
                </div>
                <div class="col-12 col-xl-4 text-end d-md-block d-none">
                    <a href="mailto:contacto@Pandorahmid.com?subject=¡Hola! Necesito información de Pandorah" class="btn btn-primary shadow-none">
                        Envíanos un correo
                    </a>
                </div>
            </div>
            <div class="row w-100 justify-content-end align-items-center">
                <div class="col-12">
                    <div class="display-2 oleo">
                        seguro <span class="text-primary">invierte en Pandorah</span> 
                    </div>
                </div>
            </div>
            <div class="row w-100 justify-content-center align-items-center mt-5">
                <div class="col-12 col-xl-6 text-center">
                    <div class="lead text-uppercase">
                        La seguridad, tranquilidad y certeza jurídica de Yucatán lo hacen ser el lugar idóneo para invertir
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container position-relative z-index-1">
            <div class="d-flex g-5 row align-items-stretch">
                <div class="col-12 d-flex">
                    <div class="card card-body bg-dark-special">
                        <div class="display-4 text-primary mb-3">
                            <i class="bi bi-sun"></i>
                        </div>
                        <div class="text-dark oleo h3 fw-bold text-uppercase mb-3">
                            El mundo de <span class="text-primary">Pandorah</span>
                        </div>
                        <div class="text-md mb-3">
                            <ul>
                                <li>Casa club</li>
                                <li>Parques temáticos</li>
                                <li>Calles de acceso asfaltadas</li>
                                <li>Calles internas asfaltadas</li>
                                <li>Luz aérea en todo el Desarrollo</li>
                            </ul>
                        </div>

                        <div class="">
                            <button class="btn btn-link p-0 text-uppercase text-primary">
                                Conoce Pandorah <i class="bi ms-3 bi-arrow-right-circle-fill"></i>
                            </button>
                        </div>
                    </div>
                </div>

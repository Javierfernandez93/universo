<div id="app">
        ...
        <div class="container expand animation-fall-down" style="--delay:150ms">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-6 lead text-dark">
                    <div>¡Invierte hoy en la tierra del futuro!</div>
                    <div>Thalmo se encuentra en una zona donde garantizamos la plusvalía y el rendimiento de tu inversión hasta en un 30% anual.</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="row g-5 py-3 text-uppercase letter-spacing-3 expand animation-fall-down oleo" style="--delay:350ms" id="imagine">
        ...
        <div class="col-xl text-center font-color">
            Y Thalmo es el lugar donde vivimos
        </div>
        <div class="col-xl-auto mx-5 d-md-block d-none">
            <i class="bi bi-star-fill text-primary"></i>
        </div>
            ...
            <div class="col-12 col-md-6 col-xl-4 text-center">
                <div class="card bg-dark-special card-body p-5">
                    <div class="card-body px-0">
                        ...
                        <div class="h3 oleo text-dark mb-3">Imagina <span class="text-primary">Thalmo</span></div>
                        <div class="text-dark lead">
                            A 11 minutos del desarrollo se encuentra el puerto principal de Yucatán, “puerto progreso”, el cual cuenta con apertura a mercados nacionales e internacionales, también como el arribo de cruceros turísticos.
                        </div>
                    </div>
                    
                    <div class="card-footer d-flex justify-content-center px-0">
                        <a target="_blank" :href="'9995013045'.sendWhatsApp('¡Hola! Quiero conocer Thalmo ¿Puedes darme más información?')" class="btn btn-primary btn-lg shadow-none">
        ...
        <div class="container position-absolute z-index-1 expand animation-fall-down" style="--delay:750ms">
            <div class="row w-100 justify-content-end align-items-center mb-n3">
                ...
                <div class="col-12 col-xl-4 text-end d-md-block d-none">
                    <a href="mailto:contacto@Thalmomid.com?subject=¡Hola! Necesito información de Thalmo" class="btn btn-primary shadow-none">
                        Envíanos un correo
                    </a>
                </div>
            </div>
            <div class="row w-100 justify-content-end align-items-center">
                <div class="col-12">
                    <div class="display-2 oleo">
                        seguro <span class="text-primary">invierte en Thalmo</span> 
                    </div>
                </div>
            </div>
